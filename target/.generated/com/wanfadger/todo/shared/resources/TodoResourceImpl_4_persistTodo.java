...
public class TodoResourceImpl_4_persistTodo extends AbstractRestAction<com.wanfadger.todo.shared.models.Todo> {
    public TodoResourceImpl_4_persistTodo(
            HttpParameterFactory httpParameterFactory,
            String defaultDateFormat,
            com.wanfadger.todo.shared.models.Todo todo) {
        super(httpParameterFactory, defaultDateFormat, HttpMethod.POST, "/todos");
